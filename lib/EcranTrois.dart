    ...
    child: AppBar(
      ...
      title: _isSearchActive
          ? TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Recherche...',
                hintStyle: TextStyle(color: Color.fromARGB(255, 219, 133, 4)),
                border: InputBorder.none,
                icon: Icon(Icons.search, color: Color.fromARGB(255, 219, 133, 4)),
              ),
              onChanged: (query) {
                // Appel à la fonction filterSearchResults
      ...
      actions: [
        IconButton(
          ...
          onPressed: () {
            setState(() {
              ...
              if (!_isSearchActive) {
                _searchController.clear(); // Efface la recherche lorsqu'on ferme
                filterSearchResults(''); // Réinitialise la recherche en affichant tout
              }
            });
          },
        ),
        IconButton(
          ...
          onPressed: () {
            _scaffoldKey.currentState?.openEndDrawer(); // Ouvre le menu latéral
          },
        ),
      ],
    ),
        ...
        endDrawer: Drawer(
          child: Container(
            ...
            child: ListView(
              ...
              children: [
                DrawerHeader(
                  decoration: BoxDecoration(color: Color.fromARGB(255, 15, 54, 87)),
                  child: Text(
                    'Options',
